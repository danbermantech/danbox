...
const GameOverScreen = ()=>{
  ...
  return (
    <div className="flex flex-col gap-2">
      <h1 className="text-4xl text-black text-center">Game Over</h1>
      <div className="flex flex-row flex-wrap justify-center gap-2">
        {sortedPlayers.map((player, index)=>(
          <div className="flex flex-col items-center justify-center">
            <div className="text-4xl text-black text-center">{index+1}</div>
      ...
      <button onClick={()=>{
        dispatch(restart())
      }} className="p-2 bg-gray-200 rounded-2xl text-black font-bold bg-gradient-radial from-gray-200 to-gray-400">Restart</button>
    </div>
  )
}
